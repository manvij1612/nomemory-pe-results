...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['NRHybSur3dq8_mem'] = ['luminosity_distance', 'geocent_time', 'chirp_mass', 'mass_ratio', 'chi_1', 'chi_2', 'theta_jn', 'psi', 'phase', 'azimuth', 'zenith', 'time_jitter', 'log_likelihood', 'log_prior', 'ra', 'dec', 'H1_matched_filter_snr', 'H1_optimal_snr', 'L1_matched_filter_snr', 'L1_optimal_snr', 'maximum_frequency', 'pn_spin_order', 'pn_tidal_order', 'pn_phase_order', 'pn_amplitude_order', 'reference-frequency', 'f-min', 'total_mass', 'mass_1', 'mass_2', 'a_1', 'cos_tilt_1', 'a_2', 'cos_tilt_2', 'phi_jl', 'phi_12', 'tilt_1', 'tilt_2', 'symmetric_mass_ratio', 'iota', 'spin_1x', 'spin_1y', 'spin_1z', 'spin_2x', 'spin_2y', 'spin_2z', 'phi_1', 'phi_2', 'chi_eff', 'chi_1_in_plane', 'chi_2_in_plane', 'chi_p', 'comoving_distance', 'mass_1_source', 'mass_2_source', 'chirp_mass_source', 'total_mass_source', 'H1_matched_filter_abs_snr', 'H1_matched_filter_snr_angle', 'L1_matched_filter_abs_snr', 'L1_matched_filter_snr_angle', 'comoving_volume', 'inverted_mass_ratio', 'chi_p_2spin', 'beta', 'psi_J', 'final_spin', 'peak_luminosity', 'final_mass', 'final_mass_source', 'radiated_energy', 'H1_time', 'L1_time', 'H1_L1_time_delay', 'network_optimal_snr', 'network_matched_filter_snr', 'cos_theta_jn', 'viewing_angle', 'cos_iota', 'redshift'];
    list['GWSurr'] = ['luminosity_distance', 'geocent_time', 'chirp_mass', 'mass_ratio', 'chi_1', 'chi_2', 'theta_jn', 'psi', 'phase', 'azimuth', 'zenith', 'time_jitter', 'log_likelihood', 'log_prior', 'ra', 'dec', 'H1_matched_filter_snr', 'H1_optimal_snr', 'L1_matched_filter_snr', 'L1_optimal_snr', 'maximum_frequency', 'pn_spin_order', 'pn_tidal_order', 'pn_phase_order', 'pn_amplitude_order', 'reference-frequency', 'f-min', 'total_mass', 'mass_1', 'mass_2', 'a_1', 'cos_tilt_1', 'a_2', 'cos_tilt_2', 'phi_jl', 'phi_12', 'tilt_1', 'tilt_2', 'symmetric_mass_ratio', 'iota', 'spin_1x', 'spin_1y', 'spin_1z', 'spin_2x', 'spin_2y', 'spin_2z', 'phi_1', 'phi_2', 'chi_eff', 'chi_1_in_plane', 'chi_2_in_plane', 'chi_p', 'comoving_distance', 'mass_1_source', 'mass_2_source', 'chirp_mass_source', 'total_mass_source', 'H1_matched_filter_abs_snr', 'H1_matched_filter_snr_angle', 'L1_matched_filter_abs_snr', 'L1_matched_filter_snr_angle', 'comoving_volume', 'inverted_mass_ratio', 'chi_p_2spin', 'beta', 'psi_J', 'final_spin', 'peak_luminosity', 'final_mass', 'final_mass_source', 'radiated_energy', 'H1_time', 'L1_time', 'H1_L1_time_delay', 'network_optimal_snr', 'network_matched_filter_snr', 'cos_theta_jn', 'viewing_angle', 'cos_iota', 'redshift'];
    list['NRHybSur3dq8'] = ['luminosity_distance', 'geocent_time', 'chirp_mass', 'mass_ratio', 'chi_1', 'chi_2', 'theta_jn', 'psi', 'phase', 'azimuth', 'zenith', 'time_jitter', 'log_likelihood', 'log_prior', 'ra', 'dec', 'H1_matched_filter_snr', 'H1_optimal_snr', 'L1_matched_filter_snr', 'L1_optimal_snr', 'maximum_frequency', 'pn_spin_order', 'pn_tidal_order', 'pn_phase_order', 'pn_amplitude_order', 'reference-frequency', 'f-min', 'total_mass', 'mass_1', 'mass_2', 'a_1', 'cos_tilt_1', 'a_2', 'cos_tilt_2', 'phi_jl', 'phi_12', 'tilt_1', 'tilt_2', 'symmetric_mass_ratio', 'iota', 'spin_1x', 'spin_1y', 'spin_1z', 'spin_2x', 'spin_2y', 'spin_2z', 'phi_1', 'phi_2', 'chi_eff', 'chi_1_in_plane', 'chi_2_in_plane', 'chi_p', 'comoving_distance', 'mass_1_source', 'mass_2_source', 'chirp_mass_source', 'total_mass_source', 'H1_matched_filter_abs_snr', 'H1_matched_filter_snr_angle', 'L1_matched_filter_abs_snr', 'L1_matched_filter_snr_angle', 'comoving_volume', 'inverted_mass_ratio', 'chi_p_2spin', 'beta', 'psi_J', 'final_spin', 'peak_luminosity', 'final_mass', 'final_mass_source', 'radiated_energy', 'H1_time', 'L1_time', 'H1_L1_time_delay', 'network_optimal_snr', 'network_matched_filter_snr', 'cos_theta_jn', 'viewing_angle', 'cos_iota', 'redshift'];
    ...
    var data = {}
    data['NRHybSur3dq8_mem'] = {'width': 200.00000000000006, 'height': 200.0, 'seperation': 9.999999999999943, 'x0': 100.0, 'y0': 100.0};
    data['GWSurr'] = {'width': 200.00000000000006, 'height': 200.0, 'seperation': 9.999999999999943, 'x0': 100.0, 'y0': 100.0};
